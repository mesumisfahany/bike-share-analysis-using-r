...
Using Power BI, we build this interactive [dashboard](https://) to make it easier to visualise what time of the day, casual riders and annual members were most likely to use a service on a given weekday, sorting the data by **start_time** 
